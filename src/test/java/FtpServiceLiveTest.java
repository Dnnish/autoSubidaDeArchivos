...
@Disabled
public class FtpServiceLiveTest {
...
//        //Arrange
//        byte[] expectedResult = "hola mundo".getBytes();
//        FtpService ftpService = FtpService.builder().host("10.0.0.22").port(21).username("dmkt").password("zl<M(+Ek74").build();
//        String dir = "prueba/";
//        String filename = "test.txt";
//        //Act
//        byte[] resultByte = ftpService.getFileContent(dir, filename);
//        //Assert
//        Assertions.assertArrayEquals(expectedResult, resultByte);
//    }
    @Test
   ...
   @Test
    public void deleteFile()throws IOException{
        //Arrange
       boolean expectedResult = true;
       IFileService ftpService = FtpService.builder().host("10.0.0.22").port(21).username("dmkt").password("zl<M(+Ek74").build();
       String dir = "prueba/";
       String filename = "test.txt";
